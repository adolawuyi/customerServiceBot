...
public class DefaultTemplate {
    private ArrayList<Questions> questionsSet;
    public DefaultTemplate() {
        questionsSet = new ArrayList<Questions>();
        String q = "Where does the sun rise?";
        String[] a = {"East", "West", "South", "North"};
        questionsSet.add(new Questions(q, a, "East"));
        ...
        questionsSet.add(new Questions(q, a, "Alexander Bell"));
    }
